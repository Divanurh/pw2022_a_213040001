          ...
          <div class="col-8">
            <form action="" method="get">
              <div class="input-group mb-3">
                <input type="text" class="form-control" name="keyword" id="keyword" autocomplete="off" placeholder="masukan pencarian..." autofocus>
  ...
  <tbody>
    <tr class="align-middle">
      ...
      <td>
          ...
          <a href="hapus.php?id=<?= $mhs["id"]; ?>"class="btn badge bg-danger" onclick="return confirm('yakin akan menghapus?')">hapus</a>
      </td>
    </tr>
  </tbody>
  <?php } 
